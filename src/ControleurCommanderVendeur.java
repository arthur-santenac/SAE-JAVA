...
public class ControleurCommanderVendeur implements EventHandler<ActionEvent>{
    
    private LivreExpress appli;

    public ControleurCommanderVendeur(int idMag, LivreExpress appli, ConnexionMySQL laConnexion){
        this.appli = appli;
    }
